...
|                                 | Description                                      |
|---------------------------|--------------------------------------------------|
| <i class="fa fa-list-check fa-2x"></i> | The number of questions answered on an exam (e.g. 12 out of 20) |
| <i class="fa fa-check-circle fa-2x"></i> | If somebody has completed a survey (binary data; yes/no) |
| <i class="fa fa-users fa-2x"></i>    | The number of students in a class (e.g. 20, 32) |
...
|                                 | Description                                      |
|---------------------------|--------------------------------------------------|
| <i class="fa fa-thermometer-half fa-2x"></i> | Temperature of a liquid (e.g. 20 &deg;C) |
| <i class="fa fa-ruler fa-2x"></i>    | Height of people in a cohort (e.g. 168 cm) |
| <i class="fa fa-heartbeat fa-2x"></i> | Average heart rate in a patient (e.g. 70 beats per minute) |
| <i class="fa fa-tint fa-2x"></i>     | Water levels in an aquifer (e.g. 2.4 metres) |
...
|                                 | Description                                      |
|---------------------------|--------------------------------------------------|
| <i class="fa fa-eye fa-2x"></i>      | Eye colour (e.g. blue, brown) |
| <i class="fa fa-university fa-2x"></i> | Education level (e.g. primary school, secondary school) |
| <i class="fa fa-flask fa-2x"></i>    | Treatment group (e.g. control, treatment) |
...
|                                 | Description                                      |
|---------------------------|--------------------------------------------------|
| <i class="fa fa-star fa-2x"></i>     | Rating scale (e.g., 1 to 5 stars for difficulty levels) |
| <i class="fa fa-trophy fa-2x"></i>   | Rank or position (e.g., 1st, 2nd, 3rd place in a tournament) |
| <i class="fa fa-sort-amount-up fa-2x"></i> | Order or progression (e.g., low, medium, high priority) |
