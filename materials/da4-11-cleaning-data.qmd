...
So, it's good to pay attention to what colours you use in your plots. There are some default options, or you can use your own colour scheme. We'll cover both below. We'll use a small subset of the data so we can highlight the differences better.
